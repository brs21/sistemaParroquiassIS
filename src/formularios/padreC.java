...
public class padreC extends javax.swing.JDialog {

    DefaultTableModel model;
    public padreC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
void cargarPadresBautizado(String valor){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fila>=0){
            try {
                nuevaConfirma.txtDuiPadreConfirmado.setText(tablaPadresBautizados.getValueAt(fila, 0).toString());
            nuevaConfirma.txtNombrePadreConfirmado.setText(tablaPadresBautizados.getValueAt(fila, 1).toString());
            nuevaConfirma.txtApellidoPadreConfirmado.setText(tablaPadresBautizados.getValueAt(fila, 2).toString());
            this.dispose();
            } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(padreC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                padreC dialog = new padreC(new javax.swing.JFrame(), true);
