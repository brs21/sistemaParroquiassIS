 ...
 * @author Boris_
 */
public class padrinoB extends javax.swing.JDialog {

    
    DefaultTableModel model;
    public padrinoB(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   ...
   void bloquearParaActualizar(){
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if(fila>=0){
            try {
                nuevoBautismo.txtDuiPadrino1Bautizado.setText(tablaPadrinoB.getValueAt(fila, 0).toString());
            nuevoBautismo.txtNombrePadrino1Bautizado.setText(tablaPadrinoB.getValueAt(fila, 1).toString());
            nuevoBautismo.txtApellidoPadrino1Bautizado.setText(tablaPadrinoB.getValueAt(fila, 2).toString());
            this.dispose();
            } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(padrinoB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                padrinoB dialog = new padrinoB(new javax.swing.JFrame(), true);
