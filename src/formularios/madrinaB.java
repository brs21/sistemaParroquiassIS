...
public class madrinaB extends javax.swing.JDialog {

    DefaultTableModel model;
    public madrinaB(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
void limpiar(){
    ...
    private void initComponents() {
        ...
        tablaMadrinaB = new javax.swing.JTable();
        ...
        tablaMadrinaB.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jScrollPane1.setViewportView(tablaMadrinaB);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
       ...
       duiPadrinoBautizado=txtDuiMadrinaB.getText();
       nomPadrinoBautizado=txtNombreMadrinaB.getText();
       apePadrinoBautizado=txtApellidoMadrinaB.getText();
       String sql;
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
          int fila = tablaMadrinaB.getSelectedRow();
        if(fila>=0){
            try {
                nuevoBautismo.txtDuiPadrino2Bautizado.setText(tablaMadrinaB.getValueAt(fila, 0).toString());
            nuevoBautismo.txtNombrePadrino2Bautizado.setText(tablaMadrinaB.getValueAt(fila, 1).toString());
            nuevoBautismo.txtApellidoPadrino2Bautizado.setText(tablaMadrinaB.getValueAt(fila, 2).toString());
            this.dispose();
            } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(madrinaB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                madrinaB dialog = new madrinaB(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable tablaMadrinaB;
