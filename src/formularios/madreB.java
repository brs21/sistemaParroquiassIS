...
public class madreB extends javax.swing.JDialog {

     DefaultTableModel model;
    public madreB(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if(fila>=0){
            try {
                nuevoBautismo.txtDuiMadreBautizado.setText(tablaMadres.getValueAt(fila, 0).toString());
            nuevoBautismo.txtNombreMadreBautizado.setText(tablaMadres.getValueAt(fila, 1).toString());
            nuevoBautismo.txtApellidoMadreBautizado.setText(tablaMadres.getValueAt(fila, 2).toString());
            this.dispose();
            } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(madreB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                madreB dialog = new madreB(new javax.swing.JFrame(), true);
